...
""" 
Assigment notes:
    * If number of students was doubledwe would change constructor of the Task
        class :
        self.pages = random.randrange(1, 41) # 20 students average 2 tasks/hour

    * If avaeage task was cut in half we would change constructor of the Task 
        class :
        self.pages = random.randrange(1, 11) # anywhere between 1 and 10
    * If we would line to pass the number of students as a parameter we would 
      we would  modify the `init` method of the `Task` class:
        * add a parameter students that woud be an integer
        * change self.pages = random.randrange(1, students + 1) 
"""
